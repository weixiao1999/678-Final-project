...
#delete urbanpop,co2
```{r}
f1 <- lmer(lifeexp~fertilityrate+CO2+log(healthexppercapita)+inflation+log(gdppercapita)+(1+fertilityrate+CO2+log(healthexppercapita)+inflation+log(gdppercapita)|Group),data=lifeexp)
summary(f1)
```
